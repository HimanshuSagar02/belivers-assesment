    ...
    <>
      <header className="navbar-container">
        ...
        <nav className="web-nav">
          ...
          <Link className="active" to="/corebtr-offline" data-discover="true" aria-current="page">CoreBTR Offline</Link>
        ...
        {isMobileMenuOpen && (
          <nav className="mobile-nav">
            <a className="" href="/" data-discover="true">Home</a>
            <a className="" href="#" target="_blank" rel="noreferrer">About Dr. ZV</a>
            <Link className="active" to="/corebtr-offline" data-discover="true">CoreBTR Offline</Link>
        ...
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              ...
              <li><Link className="active" to="/corebtr-offline" data-discover="true" aria-current="page">CoreBTR Offline</Link></li>
